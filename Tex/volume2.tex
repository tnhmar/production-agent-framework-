...
% TODO: Rewrite per edit plan Section 4, Chapter 1.
% Keep: 6-principles table, runtime requirements list, concurrency section, §4.9, §4.10.
% Delete: §4.1–§4.8 interface subsections (presented without motivation).
% Replace: interface subsections → "Interface Catalogue as an Architecture Decision" + Fig 1.1 + Fig 1.2.
% Add: "Before you build: the failure modes" narrative opening (2 pages).
